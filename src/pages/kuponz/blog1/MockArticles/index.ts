...
const articleList = [
  {
    ...
    image: image1For1,
    excerpt:
      "Westman Atelier launched Powder Cheek Duos in two different formats ($75 each). I picked up two of the Baby Cheeks Powder Blush Duos and two of the Baby Cheeks Powder Blush + Sculpting duos. I also splurged on the Powder II Brush $85) to try.",
    content: [
      {
        image: image1For1,
        excerpt: [
      ...
      },
      {
        ...
        excerpt: [
          ...
          "Baby Cheeks Powder Blush Duo Coquette/Mimi Lip Suede Lacker + Squeaky Clean Liquid Lip Balm Nectar",
...

  {
    ...
    image: image2For1,
    excerpt:
      "Armani Beauty recently launched a shine version of the Luminous Silk Cheek Tint ($39 each). ",
    content: [
      {
        image: image2For1,
        excerpt: [
          "I’ve been such a huge fan of the original satiny/matte formula because they have the best wear time for a liquid blush. The shine versions have a soft luminous glow in a very subtle way. They are noticeably more glowy than the originals but aren’t too shimmery or too dewy.",
      ...
      },
      {
        image: image2For3,
        excerpt: [
          "# Armani53S Cosmic Pink is a soft cool baby pink, wearing it with the Chanel Rouge Coco Baume in Blushing Pink + Armani Prisma Glass 08 Sugar Halo on the lips",
        ],
      },
      // {
      //   image: image2For4,
...

  {
    ...
    image: image5For1,
    excerpt:
      "I’ve been MIA for the past couple of weeks as I just moved from Tampa to Miami!",
    content: [
      {
        image: image5For1,
        excerpt: [
          "We’ve all been living out of boxes and moving boxes as we packed everything up for our big move. We are finally in South Beach! I’ll share more soon but you can see a sneak peek of our new place on my LIFE UPDATES highlights on Instagram if you’re curious!",
      ...
      },
      {
        image: image5For2,
        excerpt: [
          "I’m still not a traditional primer kind of person, but I will use a multi-tasking primer/moisturizer/spf underneath makeup. I still love the Bobbi Brown Vitamin Enriched Face Base and the Charlotte Tilbury Invisible UV Flawless Primer with SPF 50.",
          "If I want something to mix in or add a bit of glow as a base, I still swear by the Charlotte Tilbury Hollywood Flawless Filter (I use Shade 3 or 4.5, swatches here) as a staple, but these days I’ve been really loving the Dior Forever Star Filter (I use Shade 3, swatches + comparisons here) and Saie Glowy Super Gel in Roseglow.",
          "I also really like the new Supergoop! Glowscreen Soft-Radiance Drops which is a mineral formula with SPF40. I’ve been testing out the darker shade Golden Hour but might also pick up Sunrise to try.",
        ],
      },
      {
        image: image5For3,
        excerpt: [
          "Two favorites I will always repurchase are the Natasha Denona Hy-Glam Concealer for full coverage (still creamy and very easy to blend) or the YSL Touche Eclat. The other ones shown above are also ones I’ve loved, but right now I’ve been sticking to the Natasha Denona one most of the time.",
          "I have been very curious about the Haus Labs Triclone Skin Tech Concealer and will be picking it up during the sale.",
        ],
      },
    ],
  },
  ...
  {
    id: "6",
    title: "Chanel Active Beauty Set Holiday 2025",
    date: "2025-01-15",
    image: image6For1,
    excerpt:
      "Chanel launched another Holiday Beauty Set for this year called the Active Beauty Set ($221).",
    content: [
      {
        image: image6For1,
        excerpt: [
      ...
      },
      {
        ...
        excerpt: [
          ...
          " Both available now at Chanel.com.",
        ],
      },
    ],
  },
    ...
    content: [
      {
        image: image11For1,
        excerpt: [
          "I am so excited to share a luxury beauty gift guide today with some stunning sets from Guerlain. They’ve kindly gifted a selection of their fragrances for me to share and I am thrilled to host a giveaway too! If you’re the ultimate perfume lover or have someone in your life who has everything, Guerlain has some really special sets I think are unique.",
        ],
      },
      {
        image: image11For2,
        excerpt: [
          "There are three Perfumer’s Sets from Guerlain. These have beautiful miniatures that have a selection of the L’Art + La Matiere perfumes. They’ve brought back the Iconic Harmony ($395) and Floral Harmony ($395) both containing 8 minis with a twist off cap. Each bottle has 10 ml of product. They also have a new trio with three of my personal favorites",
        ],
      },
      {
        image: image11For3,
        excerpt: [
          "The Iconic Harmony Set has Neroli Outrenoir, Spiritueuse Double Vanille, Rose Barbare, Cuir Beluga, Musc Outreblanc, Angelique Noire, Herbes Troublantes and Oud Nude.",
        ],
      },
      {
        image: image11For4,
        excerpt: [
          "This year they added a new variation called the Iconic Eaux de Parfum Set ($190) with three pieces including Neroli Outrenoir, Angelique Noire and Musc Outreblanc.",
        ],
      },
    ],
  },
