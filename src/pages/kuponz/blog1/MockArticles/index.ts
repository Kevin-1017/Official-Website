import image1For1 from "./images/1.1.jpg";
import image1For2 from "./images/1.2.jpg";
import image2For1 from "./images/2.1.jpg";
import image2For2 from "./images/2.2.jpg";
import image2For3 from "./images/2.3.jpg";
// import image2For4 from "./images/2.4.jpg";
// import image2For5 from "./images/2.5.jpg";
import image3For1 from "./images/3.1.jpg";
import image3For2 from "./images/3.2.jpg";
import image3For3 from "./images/3.3.jpg";
import image4For1 from "./images/4.1.jpg";
import image4For2 from "./images/4.2.jpg";
import image5For1 from "./images/5.1.jpg";
import image5For2 from "./images/5.2.jpg";
import image5For3 from "./images/5.3.jpg";
import image6For1 from "./images/6.1.jpg";
import image6For2 from "./images/6.2.jpg";
import image6For3 from "./images/6.3.jpg";
import image6For4 from "./images/6.4.jpg";
import image6For5 from "./images/6.5.jpg";
import image7For1 from "./images/7.1.jpg";
import image7For2 from "./images/7.2.jpg";
// import image8For1 from "./images/8.1.jpg";
import image8For2 from "./images/8.2.jpg";
// import image9For1 from "./images/9.1.jpg";
// import image9For2 from "./images/9.2.jpg";
// import image9For3 from "./images/9.3.jpg";
import image10For1 from "./images/10.1.jpg";
import image10For2 from "./images/10.2.jpg";
import image10For3 from "./images/10.3.jpg";
import image10For4 from "./images/10.4.jpg";
import image10For5 from "./images/10.5.jpg";
import image11For1 from "./images/11.1.jpg";
import image11For2 from "./images/11.2.jpg";
import image11For3 from "./images/11.3.jpg";
import image11For4 from "./images/11.4.jpg";

const articleList = [
  {
    id: '1',
    title: "Parisian Street Style: A Fashion Photographer’s Guide",
    date: "2025-05-10",
    image: image1For1,
    excerpt: 'Westman Atelier launched Powder Cheek Duos in two different formats ($75 each). I picked up two of the Baby Cheeks Powder Blush Duos and two of the Baby Cheeks Powder Blush + Sculpting duos. I also splurged on the Powder II Brush $85) to try.',
    content: [
      {
        image: image1For1,
        excerpt: [" I love the unique powder formula. It has an interesting almost creamy powder texture with a very blurred matte finish. It makes the skin look very blurred. I’ve been a huge fan of the tones in her Cream Blush Baby Cheeks and had high hopes for these powder versions. While I really love the formula, I don’t love all the colors – but I think that is to be expected since they have different variations and undertones.Colors are all mattes.",
      ...
      {
        image: image1For2,
        excerpt: ["Lip + Cheek looks with each duo layered on the face:", "Baby Cheeks Powder Blush Duo Coquette/Mimi Lip Suede Lacker + Squeaky Clean Liquid Lip Balm Nectar", "This duo pulls very light on my skin, if I were even 1/2 shade darker I don’t think this would show up on my skin tone."]
      },
    ]
  },
  ...
  {
    id: '2',
    title: "Armani Luminous Silk Cheek Tint Shine",
    date: "2025-05-01",
    image: image2For1,
    excerpt: 'Armani Beauty recently launched a shine version of the Luminous Silk Cheek Tint ($39 each). ',
    content: [
      {
        image: image2For1,
        excerpt: ['I’ve been such a huge fan of the original satiny/matte formula because they have the best wear time for a liquid blush. The shine versions have a soft luminous glow in a very subtle way. They are noticeably more glowy than the originals but aren’t too shimmery or too dewy.', 'I shared a demo earlier in the week here to show how they blend and look on the skin in action. I find the shine versions for the two lighter shades to be on the sheer side while the darker colors have more pigment.']
      },
      {
        image: image2For2,
        excerpt: ['Overall pigment is on the softer side. Lasting power on me is still very good. Not quite as long-wearing as the natural finish, but still very very good. For skintone reference I am still a Luminous Silk Foundation Shade 6.5. It’s one of the best color matches for me in terms of undertone and color. Did a few different lip combos to coordinate with each cheek color.', '']
      },
      {
        image: image2For3,
  ...
  {
    id: '4',
    title: "Autumn-Winter Skincare Favorites for Sensitive Skin",
    date: "2016-09-06",
    image: image4For1,
    excerpt: 'As the weather shifts my skin has been in need of an extra hydration boost. The air is dry and I can definitely feel it as my arms and legs tend to get a little itchy when skin is dry.',
    content: [
      {
        image: image4For1,
        excerpt: ['My skint ype is pretty much normal combination but I do have super sensitive skin – I’ve mentioned a number of times that I’m allergic to a number of things so I always patch test items before applying them all over. However as a beauty blogger it is my duty to try and test things to be able to see first hand how they work so I don’t mind an occasional reaction here and there. Many of you liked the Spring Skincare Favorites for Sensitive Skin so today I have a roundup of Beauty Look Book sensitive-skin approved products that will help with dry skin and add that extra boost of moisture for winter months.', 'Up first are some lip products I’ve been loving right now for dry lips. You can see a more detailed comprehensive Winter Roundup from 2015 if you want more options. The Armani Him/Her Lip Care are also great options for tinted unscented options.']
      },
      {
        image: image4For2,
        excerpt: ['Clarins Instant Light Natural Lip Perfectors (c/o, all shades swatched here) and Instant Light Lip Comfort Oils (c/o, also reviewed here) are among my favorite for hydration and smooth coverage. They are scented though so if you’re super sensitive to fragrance you may want to smell first before buying – I am semi-sensitive to scent in lip products but love both. There are a number of holiday sets out so be sure to check them out (there’s also a few cute GWP options going on at Clarins). The Sweet Kisses Set has 3 lip oils at a value price, Clarins Kisses has minis of both formulas, XOXO, Clarins! has 3 full size Lip Perfectors at a good deal as well. The Dior Addict Lip Glow Pomade has been a staple for hydration and smoothing lips. It gives instant relief for dry lips and really does work to help improve texture and look of the lips. I have two tubes because I want one at my desk and one to carry in my purse when I’m out and about.', 'The Lanolips 101 Fruities Duo in Strawberry and Peach are a Net-A-Porter exclusive and I cannot rave about them enough. They’re a thick but very smooth balm that feels incredible on the lips. I’ve never tried any other lip product that gives such a comforting hydrating feel like these do. The Strawberry option is also available at Ulta Beauty.']
      }
    ]
  },
  ...
  {
    id: '5',
    title: "Sephora Savings Event Spring Sale 2025 Best in Makeup",
    date: "2025-04-03",
    image: image5For1,
    excerpt: 'I’ve been MIA for the past couple of weeks as I just moved from Tampa to Miami!',
    content: [
      {
        image: image5For1,
        excerpt: ['We’ve all been living out of boxes and moving boxes as we packed everything up for our big move. We are finally in South Beach! I’ll share more soon but you can see a sneak peek of our new place on my LIFE UPDATES highlights on Instagram if you’re curious!',
          'We are slowly but surely settling into our new place and getting everything sorted. Lots of reviews and more beauty content coming your way as I get back into the swing of things. I really miss blogging and trying out new beauty products. I can’t wait to get back into my routine.'
        ]
      },
      {
        image: image5For2,
        excerpt: ['I’m still not a traditional primer kind of person, but I will use a multi-tasking primer/moisturizer/spf underneath makeup. I still love the Bobbi Brown Vitamin Enriched Face Base and the Charlotte Tilbury Invisible UV Flawless Primer with SPF 50.', 'If I want something to mix in or add a bit of glow as a base, I still swear by the Charlotte Tilbury Hollywood Flawless Filter (I use Shade 3 or 4.5, swatches here) as a staple, but these days I’ve been really loving the Dior Forever Star Filter (I use Shade 3, swatches + comparisons here) and Saie Glowy Super Gel in Roseglow.', 'I also really like the new Supergoop! Glowscreen Soft-Radiance Drops which is a mineral formula with SPF40. I’ve been testing out the darker shade Golden Hour but might also pick up Sunrise to try.']
      },
      {
        image: image5For3,
        excerpt: ['Two favorites I will always repurchase are the Natasha Denona Hy-Glam Concealer for full coverage (still creamy and very easy to blend) or the YSL Touche Eclat. The other ones shown above are also ones I’ve loved, but right now I’ve been sticking to the Natasha Denona one most of the time.', 'I have been very curious about the Haus Labs Triclone Skin Tech Concealer and will be picking it up during the sale.']
      }
    ]
  },
  ...
  {
    id: '6',
    title: "Chanel Active Beauty Set Holiday 2024",
    date: "2025-11-15",
    image: image6For1,
    excerpt: 'Chanel launched another Holiday Beauty Set for this year called the Active Beauty Set ($221).',
    content: [
      {
        image: image6For1,
        excerpt: ['Chanel launched another Holiday Beauty Set for this year called the Active Beauty Set ($221). It seems to be exclusive to Chanel.com and and Chanel beauty boutiques. The set has three full-sized permanent items in a large pouch. I love that Chanel released two sizes of pouches this year, the fluffy bag with the snowflake charm is so cute.', 'I ordered the Active Beauty Set online at Chanel.com and my order came with a cute little charm. I am not sure if all online orders come with one but I do know a lot of stores and counters have them with holiday purchases. The snowflake charm is one I got from my SA in store.']
      },
      {
        image: image6For2,
        excerpt: []
      ...
      {
        image: image6For4,
        excerpt: ['This set has the La Creme Main hand cream (my favorite for a non-sticky formula), UV Essentiel (love this formula) and a Hydra Beauty Essence Mist (scented but I love it).']
      },
      {
        image: image6For5,
        excerpt: ['Quick side by side look at the Active Beauty Set (large pouch) and Maximum Brilliance Set (small/regular pouch, swatches in this post here, still in stock!). You can buy all the items individually and they do not give you a price break for buying a set, but for a holiday gift I think the pouch sets have such a beautiful presentation and definitely have that wow factor.', ' Both available now at Chanel.com.']
      },
    ]
  },
  {
    id: '7',
    title: "Dior Forever Nude Bronze Review",
    date: "2025-02-13",
    image: image7For1,
    excerpt: 'Dior Beauty launched new bronzers in two different formats called the Forever Nude Bronzer ($52, available in 8 shades) that come in a soft glow and matte option along with a Forever Nude Bronze Jumbo ($64, available in 4 shades) in an oversized compact.',
    content: [
      {
        image: image7For1,
        excerpt: ['Dior Beauty launched new bronzers in two different formats called the Forever Nude Bronzer ($52, available in 8 shades) that come in a soft glow and matte option along with a Forever Nude Bronze Jumbo ($64, available in 4 shades) in an oversized compact.', 'Both come in a stunning quilted stitched mirrored compact that has an ultra luxurious feel. These are soft bronzers with a floral gardenia/jasmine like scent (I can’t quite pinpoint the exact notes, but it’s a nice floral).']
      },
      {
        image: image7For2,
        excerpt: ['The bronzers launched online first and while they both have recommended shades based on your Dior foundation color, I was still unsure of which color to get. I ordered a few to try based on their charts. The names and numbers in the regular option aren’t the same as the jumbo which is a little confusing. The regular size has shades in the 01, 02 through 08 numerical order while the jumbos are listed at shades 10, 20, 30 and 40.', 'I wear either a 2.5N or 3N in Dior foundations depending on the formulas. I have a medium tan golden undertone that shifts depending on how tan I am. My winter shade pulls more olive and neutral while my summer shade pulls more golden. The Forever Skin Perfect Foundation Stick has the best matches for me. I’m getting a little bit more sun so 3N is my best match now.', 'If you’re thoroughly confused on which one to get, you’re not alone. Here’s what I bought and my thoughts on each shade. Beauty breakdown for what I’m wearing below too:', '~Foundation – Dior Forever Skin Perfect Foundation Stick in 3N ~Powder – Charlotte Tilbury Airbrush Flawless Finish Powder in Medium ~Eyeshadow – Makeup by Mario Master Mattes + Patrick Ta Eye Illusion Duo Do You Know Who I Am? ~Mascara – Tarte Tartelette Tubing Mascara ~Brows – Glossier Boy Brow Arch Pencil in Warm Brown ~Lip Gloss – Dior Addict Lip Maximizer in 090 Sparkly Sienna~Nails – Dior Vernis in 330 Coral Pop']
      }
    ]
  },
  ...
  {
    id: '11',
    title: "Holiday Gifting with Guerlain",
    date: "2024-11-22",
    image: image11For1,
    excerpt: '',
    content: [
      {
        image: image11For1,
        excerpt: ['I am so excited to share a luxury beauty gift guide today with some stunning sets from Guerlain. They’ve kindly gifted a selection of their fragrances for me to share and I am thrilled to host a giveaway too! If you’re the ultimate perfume lover or have someone in your life who has everything, Guerlain has some really special sets I think are unique.']
      },
      {
        image: image11For2,
        excerpt: ['There are three Perfumer’s Sets from Guerlain. These have beautiful miniatures that have a selection of the L’Art + La Matiere perfumes. They’ve brought back the Iconic Harmony ($395) and Floral Harmony ($395) both containing 8 minis with a twist off cap. Each bottle has 10 ml of product. They also have a new trio with three of my personal favorites']
      },
      {
        image: image11For3,
        excerpt: ['The Iconic Harmony Set has Neroli Outrenoir, Spiritueuse Double Vanille, Rose Barbare, Cuir Beluga, Musc Outreblanc, Angelique Noire, Herbes Troublantes and Oud Nude.']
      },
      {
        image: image11For4,
        excerpt: ['This year they added a new variation called the Iconic Eaux de Parfum Set ($190) with three pieces including Neroli Outrenoir, Angelique Noire and Musc Outreblanc.']
      }
    ]
  },
];
